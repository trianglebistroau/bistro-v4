...
export default function CreateIdeaCard({ onClick }: Props) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex aspect-square w-full flex-col items-center justify-center gap-3 rounded-[22px] bg-[#e3ecfb] p-5 transition-transform hover:-translate-y-1 sm:aspect-auto sm:h-[215px] sm:w-full sm:gap-5 sm:p-6"
    >
