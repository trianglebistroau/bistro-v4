...
// Static shortlist of draggable topic chips (sourced from constants/topics.ts).
// The old per-map "Add Your Own" custom chips are disabled, so the panel holds
// no persisted state of its own — only the canvas (MindMapCanvas) is saved.
